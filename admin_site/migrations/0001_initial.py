...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transaction_user', models.CharField(max_length=250, verbose_name='Transaction User')),
                ('transaction_fullname', models.CharField(max_length=250, verbose_name='Full Name')),
                ('transaction_address', models.CharField(max_length=250, verbose_name='Address')),
                ('transaction_contactno', models.CharField(max_length=250, null=True, verbose_name='Contact Number')),
                ...
                ('transaction_pcategory', models.CharField(max_length=250, verbose_name='Product Category')),
                ('transaction_Pname', models.CharField(max_length=250, verbose_name='Product Name')),
                ('transaction_psize', models.CharField(max_length=250, verbose_name='Product Size')),
                ('transaction_qty', models.CharField(max_length=250, verbose_name='Quantity')),
                ('transaction_amount', models.CharField(max_length=250, verbose_name='Amount')),
            ],
        ),
    ]
